...
export const translations = {
  de: {
    ...
    modal: {
      ...
      steps: ['Dienstleistung', 'Objektdetails', 'Kostenträger', 'Kontakt'],
      step1_q: 'Welche Dienstleistung benötigen Sie?',
      svc_moving: 'Umzug', svc_moving_sub: 'Ich möchte umziehen',
      svc_cleaning: 'Reinigung', svc_cleaning_sub: 'Ich brauche eine Reinigung',
      svc_both: 'Umzug & Reinigung', svc_both_sub: 'Ich brauche beides',
      addr_from: 'Von – Abgangsort', addr_to: 'Nach – Zielort',
      addr_cleaning: 'Reinigungsobjekt',
      plz_not_found: 'Ort nicht gefunden',
      lift_yes: 'Lift Ja', lift_no: 'Nein',
      street_placeholder: 'Strasse & Hausnummer *',
      cleaning_types: ['Endreinigung', 'Unterhaltsreinigung', 'Büroreinigung', 'Baureinigung', 'Fensterreinigung'],
      date_label: 'Datum *', time_label: 'Bevorzugte Uhrzeit',
      rooms_label: 'Zimmer *', area_label: 'Fläche (m²) *',
      special_placeholder: 'Besondere Gegenstände (Piano, Safe, etc.) – optional',
      step3_q: 'Wer trägt die Kosten?',
      payer_self: 'Selbst (Privat)', payer_company: 'Firma', payer_social: 'Sozialamt',
      company_placeholder: 'Firmenname *',
      social_note: 'Bitte halten Sie Ihre Fallnummer für unsere Rückmeldung bereit. Wir benötigen diese zur Verarbeitung Ihres Auftrags.',
      social_note_bold: 'Hinweis:',
      firstname: 'Vorname *', lastname: 'Nachname *', phone: 'Telefon *', email: 'E-Mail *',
      remarks: 'Bemerkungen (optional)',
      back: 'Zurück', next: 'Weiter', submit: 'Offerte anfordern', sending: 'Wird gesendet…',
      success_title: 'Vielen Dank!',
      success_msg: 'Wir haben Ihre Anfrage erhalten und melden uns in Kürze bei Ihnen.',
      close: 'Schliessen',
      error: 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut.'
    }
  },
  en: {
    ...
    modal: {
      title: 'Online Quote',
      steps: ['Service', 'Property Details', 'Payer', 'Contact'],
      step1_q: 'Which service do you need?',
      svc_moving: 'Moving', svc_moving_sub: 'I want to move',
      svc_cleaning: 'Cleaning', svc_cleaning_sub: 'I need a cleaning',
      svc_both: 'Moving & Cleaning', svc_both_sub: 'I need both',
      addr_from: 'From – Origin', addr_to: 'To – Destination',
      addr_cleaning: 'Property to clean',
      plz_not_found: 'Location not found',
      lift_yes: 'Lift Yes', lift_no: 'No',
      street_placeholder: 'Street & house number *',
      cleaning_types: ['Final cleaning', 'Regular cleaning', 'Office cleaning', 'Post-construction cleaning', 'Window cleaning'],
      date_label: 'Date *', time_label: 'Preferred time',
      rooms_label: 'Rooms *', area_label: 'Area (m²) *',
      special_placeholder: 'Special items (Piano, Safe, etc.) – optional',
      step3_q: 'Who is paying?',
      payer_self: 'Self (Private)', payer_company: 'Company', payer_social: 'Social office',
      company_placeholder: 'Company name *',
      social_note: 'Please have your case number ready for our response. We need it to process your request.',
      social_note_bold: 'Note:',
      firstname: 'First name *', lastname: 'Last name *', phone: 'Phone *', email: 'E-Mail *',
      remarks: 'Remarks (optional)',
      back: 'Back', next: 'Next', submit: 'Request Quote', sending: 'Sending…',
      success_title: 'Thank you!',
      success_msg: 'We have received your request and will get back to you shortly.',
      close: 'Close',
      error: 'An error occurred. Please try again.'
    }
  },
  fr: {
    ...
    modal: {
      ...
      steps: ['Service', 'Détails du bien', 'Payeur', 'Contact'],
      step1_q: 'Quel service souhaitez-vous ?',
      svc_moving: 'Déménagement', svc_moving_sub: 'Je veux déménager',
      svc_cleaning: 'Nettoyage', svc_cleaning_sub: 'J\'ai besoin d\'un nettoyage',
      svc_both: 'Déménagement & Nettoyage', svc_both_sub: 'J\'ai besoin des deux',
      addr_from: 'De – Adresse de départ', addr_to: 'À – Adresse d\'arrivée',
      addr_cleaning: 'Bien à nettoyer',
      plz_not_found: 'Lieu introuvable',
      lift_yes: 'Ascenseur Oui', lift_no: 'Non',
      street_placeholder: 'Rue & numéro *',
      cleaning_types: ['Nettoyage de fin de bail', 'Nettoyage régulier', 'Nettoyage de bureau', 'Nettoyage après chantier', 'Nettoyage des vitres'],
      date_label: 'Date *', time_label: 'Heure souhaitée',
      rooms_label: 'Pièces *', area_label: 'Surface (m²) *',
      special_placeholder: 'Objets spéciaux (Piano, Coffre, etc.) – optionnel',
      step3_q: 'Qui prend en charge les coûts ?',
      payer_self: 'Moi-même (Privé)', payer_company: 'Entreprise', payer_social: 'Aide sociale',
      company_placeholder: 'Nom de l\'entreprise *',
      social_note: 'Veuillez avoir votre numéro de dossier prêt pour notre réponse. Nous en avons besoin pour traiter votre demande.',
      social_note_bold: 'Remarque :',
      firstname: 'Prénom *', lastname: 'Nom *', phone: 'Téléphone *', email: 'E-Mail *',
      remarks: 'Remarques (optionnel)',
      back: 'Retour', next: 'Suivant', submit: 'Demander un devis', sending: 'Envoi en cours…',
      success_title: 'Merci !',
      success_msg: 'Nous avons reçu votre demande et vous répondrons dans les plus brefs délais.',
      close: 'Fermer',
  ...
  it: {
    ...
    modal: {
      ...
      steps: ['Servizio', 'Dettagli immobile', 'Pagante', 'Contatto'],
      step1_q: 'Quale servizio ti serve?',
      svc_moving: 'Trasloco', svc_moving_sub: 'Voglio traslocare',
      svc_cleaning: 'Pulizia', svc_cleaning_sub: 'Ho bisogno di una pulizia',
      svc_both: 'Trasloco & Pulizia', svc_both_sub: 'Ho bisogno di entrambi',
      addr_from: 'Da – Indirizzo di partenza', addr_to: 'A – Indirizzo di destinazione',
      addr_cleaning: 'Immobile da pulire',
      plz_not_found: 'Località non trovata',
      lift_yes: 'Ascensore Sì', lift_no: 'No',
      street_placeholder: 'Via & numero civico *',
      cleaning_types: ['Pulizia finale', 'Pulizia regolare', 'Pulizia uffici', 'Pulizia post-costruzione', 'Pulizia vetri'],
      date_label: 'Data *', time_label: 'Orario preferito',
      rooms_label: 'Stanze *', area_label: 'Superficie (m²) *',
      special_placeholder: 'Oggetti speciali (Pianoforte, Cassaforte, ecc.) – opzionale',
      step3_q: 'Chi sostiene i costi?',
      payer_self: 'Io stesso (Privato)', payer_company: 'Azienda', payer_social: 'Assistenza sociale',
      company_placeholder: 'Nome azienda *',
      social_note: 'Si prega di tenere pronto il numero del proprio dossier per la nostra risposta. Ne abbiamo bisogno per elaborare la richiesta.',
      social_note_bold: 'Nota:',
      firstname: 'Nome *', lastname: 'Cognome *', phone: 'Telefono *', email: 'E-Mail *',
      remarks: 'Note (opzionale)',
      back: 'Indietro', next: 'Avanti', submit: 'Richiedi preventivo', sending: 'Invio in corso…',
      success_title: 'Grazie!',
      success_msg: 'Abbiamo ricevuto la tua richiesta e ti risponderemo a breve.',
      close: 'Chiudi',
      error: 'Si è verificato un errore. Riprova.'
    }
  }
